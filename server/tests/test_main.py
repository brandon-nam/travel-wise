...
def test_main() -> None:
    ...
    mock_db = MagicMock()
    with (
        patch("src.main.create_app") as mock_create_app_func,
        ...
        main()
        mock_create_app_func.assert_called_once_with(mock_db)
        mock_sqlalchemy.assert_called_once_with(mock_pg_uri)
