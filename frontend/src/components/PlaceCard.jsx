...
function PlaceCard({ tag, body, highlight, comments, posts }) {
    ...
    return (
        <div className={`flex flex-col shadow items-center bg-white mx-3 mb-3 rounded  ${highlight ? "border-2 border-blue-500" : ""}`}>
            ...
            <div onClick={() => handleClickDetails(body, tag, comments, posts)} className="w-full text-right px-3 py-2 text-blue-300 cursor-pointer hover:text-blue-500 transition">
                See details
            </div>            
